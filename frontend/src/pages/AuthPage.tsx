        ...
        <div className="mx-auto grid w-full max-w-6xl overflow-hidden rounded-3xl border border-border-subtle bg-surface-primary shadow-xl lg:grid-cols-12">
          ...
          <div className="relative hidden bg-brand-green-dark p-10 text-brand-off-white lg:col-span-5 lg:flex lg:flex-col lg:justify-between">
            ...
            <div className="relative z-10">
              <span className="inline-flex items-center gap-1.5 rounded-full border border-brand-green-moss/50 bg-brand-green-moss/20 px-3 py-1 font-heading text-xs font-semibold uppercase tracking-wider text-brand-off-white">
          ...
          <div className="flex flex-col justify-center p-6 md:p-10 lg:col-span-7 lg:p-12">
            {/* Tabs Header */}
            <div className="mb-8 flex rounded-xl border border-border-subtle bg-surface-secondary/50 p-1">
              <button
                type="button"
                onClick={() => handleSwitchMode("login")}
                className={[
                  "flex-1 rounded-lg py-2.5 font-heading text-sm font-semibold transition-all",
                  mode === "login"
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div className="flex items-start gap-2 pt-1">
                  ...
                  <label htmlFor={agreeTermsId} className="font-body text-xs leading-snug text-text-secondary cursor-pointer">
                    ...
                    <button
                      type="button"
                      onClick={() => alert("Termos de Uso do The Bridge: plataforma de intermediação e cooperação técnico-científica.")}
                    ...
                    <button
                      type="button"
                      onClick={() => alert("Política de Privacidade do The Bridge: conformidade com a LGPD e sigilo de projetos industriais.")}
                      className="text-brand-green-moss underline hover:text-brand-green-dark"
                    >
